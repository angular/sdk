...
function getApiMember<T, K extends keyof T>(
  ...
  return api && api[func] || _error(apiName, func);
}
...
export const createProgram = getApiMember(ngtools2, 'createProgram', 'ngtools');
export const createCompilerHost = getApiMember(ngtools2, 'createCompilerHost', 'ngtools');
